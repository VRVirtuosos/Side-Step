...
class TestGetAudioDuration(unittest.TestCase):
    ...
    @patch("acestep.training_v2.audio_duration.logger")
...
class TestDetectMaxDuration(unittest.TestCase):
    ...
    def test_empty_list_returns_zero(self):
        ...
        from acestep.training_v2.audio_duration import detect_max_duration
    ...
    def test_picks_longest(self):
        ...
        with patch("acestep.training_v2.audio_duration.get_audio_duration", side_effect=mock_dur):
    ...
    def test_all_failures_returns_zero(self):
        ...
        with patch("acestep.training_v2.audio_duration.get_audio_duration", return_value=0):
